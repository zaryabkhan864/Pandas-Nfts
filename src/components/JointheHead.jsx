                ...
                <div className="row ">
                    <div className="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-1 order-md-2 order-sm-2 d-flex align-items-center px-5 ">
                        <div className='px-lg-5 px-md-5 px-sm-0 px-0'>
                            ...
                            <div className="para">WELCOME TO THE HERD. AN EXCLUSIVE COMMUNITY OF DIAMOND HOOVED HOLDERS. VALUE BROUGHT FROM EVERY AVENUE AND NONSTOP GROWTH WITHIN. WE ARE HERE TO BE THE GREATEST WE CAN POSSIBLY BE, AND PUSH THE LIMITS OF WEB3 DEVELOPMENT. ITS THE YEAR OF THE PANDAS, HOP IN!</div>
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12  col-12 order-lg-2 order-md-1 order-sm-1">
                        <img className="img-fluid top p-lg-5 p-md-3 p-sm-0 p-0" src="assets/images/mojo.png" alt="" />
                    </div>
                </div>
            </div>
